...
declare module '$env/static/private' {
	...
	export const POLAR_ACCESS_TOKEN: string;
	export const POLAR_PRODUCT_ID: string;
	export const POLAR_WEBHOOK_SECRET: string;
	export const POLAR_MODE: string;
	...
	export const SHARED_FOLDER_PATH: string;
	export const MEMORY_PRESSURE_WRITE: string;
	export const npm_config_local_prefix: string;
	export const PWD: string;
	export const LOGNAME: string;
	export const OWNER_TELEGRAM_USER_ID: string;
	export const ENCLAVE_URL: string;
