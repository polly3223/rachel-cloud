...
/** @internal */
export declare const Prices$inboundSchema: z.ZodMiniType<Prices, unknown>;
/** @internal */
export type Prices$Outbound = LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound;
/** @internal */
export declare const Prices$outboundSchema: z.ZodMiniType<Prices$Outbound, Prices>;
...
/** @internal */
export declare const Product$outboundSchema: z.ZodMiniType<Product$Outbound, Product>;
