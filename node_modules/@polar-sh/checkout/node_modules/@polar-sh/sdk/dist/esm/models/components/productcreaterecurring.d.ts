...
export type ProductCreateRecurringPrices = ProductPriceCustomCreate | ProductPriceFixedCreate | ProductPriceFreeCreate | ProductPriceMeteredUnitCreate | ProductPriceSeatBasedCreate;
export type ProductCreateRecurring = {
     ...
     */
    prices: Array<ProductPriceCustomCreate | ProductPriceFixedCreate | ProductPriceFreeCreate | ProductPriceMeteredUnitCreate | ProductPriceSeatBasedCreate>;
    /**
...
/** @internal */
export declare const ProductCreateRecurringMetadata$outboundSchema: z.ZodMiniType<ProductCreateRecurringMetadata$Outbound, ProductCreateRecurringMetadata>;
...
/** @internal */
export type ProductCreateRecurringPrices$Outbound = ProductPriceCustomCreate$Outbound | ProductPriceFixedCreate$Outbound | ProductPriceFreeCreate$Outbound | ProductPriceMeteredUnitCreate$Outbound | ProductPriceSeatBasedCreate$Outbound;
/** @internal */
export declare const ProductCreateRecurringPrices$outboundSchema: z.ZodMiniType<ProductCreateRecurringPrices$Outbound, ProductCreateRecurringPrices>;
...
export type ProductCreateRecurring$Outbound = {
    ...
    name: string;
    description?: string | null | undefined;
    prices: Array<ProductPriceCustomCreate$Outbound | ProductPriceFixedCreate$Outbound | ProductPriceFreeCreate$Outbound | ProductPriceMeteredUnitCreate$Outbound | ProductPriceSeatBasedCreate$Outbound>;
    medias?: Array<string> | null | undefined;
...
/** @internal */
export declare const ProductCreateRecurring$outboundSchema: z.ZodMiniType<ProductCreateRecurring$Outbound, ProductCreateRecurring>;
