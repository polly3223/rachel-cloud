...
/** @internal */
export const CustomerStateTaxId$inboundSchema = smartUnion([z.string(), TaxIDFormat$inboundSchema]);
/** @internal */
export const CustomerStateTaxId$outboundSchema = smartUnion([z.string(), TaxIDFormat$outboundSchema]);
...
/** @internal */
export const CustomerState$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
/** @internal */
export const CustomerState$outboundSchema = z.pipe(z.object({
    id: z.string(),
