...
/** @internal */
export declare const CheckoutCustomFieldData$inboundSchema: z.ZodMiniType<CheckoutCustomFieldData, unknown>;
/** @internal */
export type CheckoutCustomFieldData$Outbound = string | number | boolean | string;
/** @internal */
export declare const CheckoutCustomFieldData$outboundSchema: z.ZodMiniType<CheckoutCustomFieldData$Outbound, CheckoutCustomFieldData>;
...
/** @internal */
export declare const CheckoutProductPrice$inboundSchema: z.ZodMiniType<CheckoutProductPrice, unknown>;
/** @internal */
export type CheckoutProductPrice$Outbound = LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound;
/** @internal */
export declare const CheckoutProductPrice$outboundSchema: z.ZodMiniType<CheckoutProductPrice$Outbound, CheckoutProductPrice>;
...
/** @internal */
export declare const CheckoutPrices$inboundSchema: z.ZodMiniType<CheckoutPrices, unknown>;
/** @internal */
export type CheckoutPrices$Outbound = LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound;
/** @internal */
export declare const CheckoutPrices$outboundSchema: z.ZodMiniType<CheckoutPrices$Outbound, CheckoutPrices>;
export declare function checkoutPricesToJSON(checkoutPrices: CheckoutPrices): string;
export declare function checkoutPricesFromJSON(jsonString: string): SafeParseResult<CheckoutPrices, SDKValidationError>;
/** @internal */
export declare const CheckoutDiscount$inboundSchema: z.ZodMiniType<CheckoutDiscount, unknown>;
/** @internal */
...
/** @internal */
export declare const CheckoutDiscount$outboundSchema: z.ZodMiniType<CheckoutDiscount$Outbound, CheckoutDiscount>;
...
/** @internal */
export declare const CustomerMetadata$inboundSchema: z.ZodMiniType<CustomerMetadata, unknown>;
/** @internal */
export type CustomerMetadata$Outbound = string | number | boolean;
/** @internal */
export declare const CustomerMetadata$outboundSchema: z.ZodMiniType<CustomerMetadata$Outbound, CustomerMetadata>;
...
/** @internal */
export declare const Checkout$inboundSchema: z.ZodMiniType<Checkout, unknown>;
/** @internal */
export type Checkout$Outbound = {
    ...
    product_price: LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound | null;
    prices: {
        [k: string]: Array<LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound>;
    } | null;
...
/** @internal */
export declare const Checkout$outboundSchema: z.ZodMiniType<Checkout$Outbound, Checkout>;
