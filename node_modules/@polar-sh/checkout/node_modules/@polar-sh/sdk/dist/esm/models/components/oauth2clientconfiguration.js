...
/** @internal */
export const GrantTypes$outboundSchema = z
    .enum(GrantTypes);
/** @internal */
export const OAuth2ClientConfiguration$outboundSchema = z.pipe(z.object({
    redirectUris: z.array(z.string()),
    tokenEndpointAuthMethod: z._default(TokenEndpointAuthMethod$outboundSchema, "client_secret_post"),
