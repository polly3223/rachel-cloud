...
import { CustomerType$inboundSchema, CustomerType$outboundSchema, } from "./customertype.js";
...
/** @internal */
export const OrderCustomerTaxId$inboundSchema = smartUnion([z.string(), TaxIDFormat$inboundSchema]);
/** @internal */
export const OrderCustomerTaxId$outboundSchema = smartUnion([z.string(), TaxIDFormat$outboundSchema]);
...
/** @internal */
export const OrderCustomer$inboundSchema = z.pipe(z.object({
    id: z.string(),
...
/** @internal */
export const OrderCustomer$outboundSchema = z.pipe(z.object({
    id: z.string(),
