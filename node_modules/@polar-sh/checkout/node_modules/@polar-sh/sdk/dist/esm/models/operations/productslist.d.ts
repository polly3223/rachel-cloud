...
import { ListResourceProduct } from "../components/listresourceproduct.js";
...
/** @internal */
export declare const QueryParamProductIDFilter$outboundSchema: z.ZodMiniType<QueryParamProductIDFilter$Outbound, QueryParamProductIDFilter>;
...
/** @internal */
export declare const ProductsListQueryParamOrganizationIDFilter$outboundSchema: z.ZodMiniType<ProductsListQueryParamOrganizationIDFilter$Outbound, ProductsListQueryParamOrganizationIDFilter>;
...
/** @internal */
export declare const BenefitIDFilter$outboundSchema: z.ZodMiniType<BenefitIDFilter$Outbound, BenefitIDFilter>;
...
/** @internal */
export declare const ProductsListRequest$outboundSchema: z.ZodMiniType<ProductsListRequest$Outbound, ProductsListRequest>;
export declare function productsListRequestToJSON(productsListRequest: ProductsListRequest): string;
/** @internal */
export declare const ProductsListResponse$inboundSchema: z.ZodMiniType<ProductsListResponse, unknown>;
