...
/** @internal */
export const CheckoutCustomFieldData$inboundSchema = smartUnion([
    z.string(),
    z.int(),
    z.boolean(),
...
/** @internal */
export const CheckoutCustomFieldData$outboundSchema = smartUnion([
    z.string(),
    z.int(),
    z.boolean(),
...
/** @internal */
export const CheckoutProductPrice$inboundSchema = smartUnion([
    LegacyRecurringProductPrice$inboundSchema,
    ProductPrice$inboundSchema,
]);
/** @internal */
export const CheckoutProductPrice$outboundSchema = smartUnion([
...
/** @internal */
export const CheckoutPrices$inboundSchema = smartUnion([
    LegacyRecurringProductPrice$inboundSchema,
    ProductPrice$inboundSchema,
]);
/** @internal */
export const CheckoutPrices$outboundSchema = smartUnion([
    LegacyRecurringProductPrice$outboundSchema,
    ProductPrice$outboundSchema,
]);
export function checkoutPricesToJSON(checkoutPrices) {
    return JSON.stringify(CheckoutPrices$outboundSchema.parse(checkoutPrices));
}
export function checkoutPricesFromJSON(jsonString) {
    return safeParse(jsonString, (x) => CheckoutPrices$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CheckoutPrices' from JSON`);
}
/** @internal */
export const CheckoutDiscount$inboundSchema = smartUnion([
...
/** @internal */
export const CheckoutDiscount$outboundSchema = smartUnion([
...
/** @internal */
export const CustomerMetadata$inboundSchema = smartUnion([z.string(), z.int(), z.boolean()]);
/** @internal */
export const CustomerMetadata$outboundSchema = smartUnion([z.string(), z.int(), z.boolean()]);
...
/** @internal */
export const Checkout$inboundSchema = z.pipe(z.object({
    id: z.string(),
    ...
    customer_metadata: z.record(z.string(), smartUnion([z.string(), z.int(), z.boolean()])),
}), z.transform((v) => {
    return remap$(v, {
...
/** @internal */
export const Checkout$outboundSchema = z.pipe(z.object({
    id: z.string(),
    ...
    productPrice: z.nullable(smartUnion([
        LegacyRecurringProductPrice$outboundSchema,
        ProductPrice$outboundSchema,
    ])),
    prices: z.nullable(z.record(z.string(), z.array(smartUnion([
    ...
    customerMetadata: z.record(z.string(), smartUnion([z.string(), z.int(), z.boolean()])),
}), z.transform((v) => {
    return remap$(v, {
