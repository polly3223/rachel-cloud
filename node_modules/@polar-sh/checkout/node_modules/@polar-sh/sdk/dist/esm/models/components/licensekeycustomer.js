...
/** @internal */
export const LicenseKeyCustomerTaxId$inboundSchema = smartUnion([z.string(), TaxIDFormat$inboundSchema]);
...
/** @internal */
export const LicenseKeyCustomer$inboundSchema = z.pipe(z.object({
    id: z.string(),
