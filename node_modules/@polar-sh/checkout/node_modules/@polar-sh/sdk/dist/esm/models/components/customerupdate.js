...
/** @internal */
export const CustomerUpdateMetadata$outboundSchema = smartUnion([z.string(), z.int(), z.number(), z.boolean()]);
...
/** @internal */
export const CustomerUpdateTaxId$outboundSchema = smartUnion([z.string(), TaxIDFormat$outboundSchema]);
...
/** @internal */
export const CustomerUpdate$outboundSchema = z.pipe(z.object({
