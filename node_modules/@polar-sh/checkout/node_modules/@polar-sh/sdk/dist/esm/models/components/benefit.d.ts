...
export type Benefit = BenefitCustom | BenefitDiscord | BenefitGitHubRepository | BenefitDownloadables | BenefitLicenseKeys | BenefitMeterCredit;
/** @internal */
export declare const Benefit$inboundSchema: z.ZodMiniType<Benefit, unknown>;
/** @internal */
export type Benefit$Outbound = BenefitCustom$Outbound | BenefitDiscord$Outbound | BenefitGitHubRepository$Outbound | BenefitDownloadables$Outbound | BenefitLicenseKeys$Outbound | BenefitMeterCredit$Outbound;
/** @internal */
export declare const Benefit$outboundSchema: z.ZodMiniType<Benefit$Outbound, Benefit>;
