...
/** @internal */
export declare const CheckoutProductPrices$inboundSchema: z.ZodMiniType<CheckoutProductPrices, unknown>;
/** @internal */
export type CheckoutProductPrices$Outbound = LegacyRecurringProductPrice$Outbound | ProductPrice$Outbound;
/** @internal */
export declare const CheckoutProductPrices$outboundSchema: z.ZodMiniType<CheckoutProductPrices$Outbound, CheckoutProductPrices>;
...
/** @internal */
export declare const CheckoutProduct$inboundSchema: z.ZodMiniType<CheckoutProduct, unknown>;
/** @internal */
...
/** @internal */
export declare const CheckoutProduct$outboundSchema: z.ZodMiniType<CheckoutProduct$Outbound, CheckoutProduct>;
