...
export declare const WebhookEventType: {
    ...
    readonly CustomerSeatAssigned: "customer_seat.assigned";
    readonly CustomerSeatClaimed: "customer_seat.claimed";
    readonly CustomerSeatRevoked: "customer_seat.revoked";
    ...
    readonly SubscriptionPastDue: "subscription.past_due";
...
/** @internal */
export declare const WebhookEventType$inboundSchema: z.ZodMiniEnum<typeof WebhookEventType>;
/** @internal */
export declare const WebhookEventType$outboundSchema: z.ZodMiniEnum<typeof WebhookEventType>;
