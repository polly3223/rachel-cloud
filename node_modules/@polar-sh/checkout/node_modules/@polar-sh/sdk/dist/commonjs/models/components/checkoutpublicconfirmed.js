...
exports.CheckoutPublicConfirmed$inboundSchema = exports.CheckoutPublicConfirmedDiscount$inboundSchema = exports.CheckoutPublicConfirmedPrices$inboundSchema = exports.CheckoutPublicConfirmedProductPrice$inboundSchema = exports.CheckoutPublicConfirmedCustomFieldData$inboundSchema = void 0;
...
exports.checkoutPublicConfirmedPricesFromJSON = checkoutPublicConfirmedPricesFromJSON;
...
/** @internal */
exports.CheckoutPublicConfirmedCustomFieldData$inboundSchema = (0, smartUnion_js_1.smartUnion)([
    z.string(),
    z.int(),
    z.boolean(),
...
/** @internal */
exports.CheckoutPublicConfirmedProductPrice$inboundSchema = (0, smartUnion_js_1.smartUnion)([
...
/** @internal */
exports.CheckoutPublicConfirmedPrices$inboundSchema = (0, smartUnion_js_1.smartUnion)([
    legacyrecurringproductprice_js_1.LegacyRecurringProductPrice$inboundSchema,
    productprice_js_1.ProductPrice$inboundSchema,
]);
function checkoutPublicConfirmedPricesFromJSON(jsonString) {
    return (0, schemas_js_1.safeParse)(jsonString, (x) => exports.CheckoutPublicConfirmedPrices$inboundSchema.parse(JSON.parse(x)), `Failed to parse 'CheckoutPublicConfirmedPrices' from JSON`);
}
/** @internal */
exports.CheckoutPublicConfirmedDiscount$inboundSchema = (0, smartUnion_js_1.smartUnion)([
...
/** @internal */
exports.CheckoutPublicConfirmed$inboundSchema = z.pipe(z.object({
    id: z.string(),
