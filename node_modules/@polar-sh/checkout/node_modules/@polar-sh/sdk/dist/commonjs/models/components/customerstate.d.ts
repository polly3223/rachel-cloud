...
import { CustomerStateMeter, CustomerStateMeter$Outbound } from "./customerstatemeter.js";
...
/** @internal */
export declare const CustomerStateTaxId$inboundSchema: z.ZodMiniType<CustomerStateTaxId, unknown>;
/** @internal */
export type CustomerStateTaxId$Outbound = string | string;
/** @internal */
export declare const CustomerStateTaxId$outboundSchema: z.ZodMiniType<CustomerStateTaxId$Outbound, CustomerStateTaxId>;
...
/** @internal */
export declare const CustomerState$inboundSchema: z.ZodMiniType<CustomerState, unknown>;
/** @internal */
...
/** @internal */
export declare const CustomerState$outboundSchema: z.ZodMiniType<CustomerState$Outbound, CustomerState>;
