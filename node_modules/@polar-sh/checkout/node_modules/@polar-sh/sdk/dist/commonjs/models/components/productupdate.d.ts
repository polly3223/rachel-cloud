...
export type Two = ProductPriceCustomCreate | ProductPriceFixedCreate | ProductPriceFreeCreate | ProductPriceMeteredUnitCreate | ProductPriceSeatBasedCreate;
export type ProductUpdatePrices = ExistingProductPrice | ProductPriceCustomCreate | ProductPriceFixedCreate | ProductPriceFreeCreate | ProductPriceMeteredUnitCreate | ProductPriceSeatBasedCreate;
/**
...
export type ProductUpdate = {
     ...
     */
    prices?: Array<ExistingProductPrice | ProductPriceCustomCreate | ProductPriceFixedCreate | ProductPriceFreeCreate | ProductPriceMeteredUnitCreate | ProductPriceSeatBasedCreate> | null | undefined;
    /**
...
/** @internal */
export declare const ProductUpdateMetadata$outboundSchema: z.ZodMiniType<ProductUpdateMetadata$Outbound, ProductUpdateMetadata>;
export declare function productUpdateMetadataToJSON(productUpdateMetadata: ProductUpdateMetadata): string;
/** @internal */
export type Two$Outbound = ProductPriceCustomCreate$Outbound | ProductPriceFixedCreate$Outbound | ProductPriceFreeCreate$Outbound | ProductPriceMeteredUnitCreate$Outbound | ProductPriceSeatBasedCreate$Outbound;
/** @internal */
export declare const Two$outboundSchema: z.ZodMiniType<Two$Outbound, Two>;
export declare function twoToJSON(two: Two): string;
/** @internal */
export type ProductUpdatePrices$Outbound = ExistingProductPrice$Outbound | ProductPriceCustomCreate$Outbound | ProductPriceFixedCreate$Outbound | ProductPriceFreeCreate$Outbound | ProductPriceMeteredUnitCreate$Outbound | ProductPriceSeatBasedCreate$Outbound;
/** @internal */
export declare const ProductUpdatePrices$outboundSchema: z.ZodMiniType<ProductUpdatePrices$Outbound, ProductUpdatePrices>;
...
export type ProductUpdate$Outbound = {
    ...
    prices?: Array<ExistingProductPrice$Outbound | ProductPriceCustomCreate$Outbound | ProductPriceFixedCreate$Outbound | ProductPriceFreeCreate$Outbound | ProductPriceMeteredUnitCreate$Outbound | ProductPriceSeatBasedCreate$Outbound> | null | undefined;
    medias?: Array<string> | null | undefined;
    attached_custom_fields?: Array<AttachedCustomFieldCreate$Outbound> | null | undefined;
};
/** @internal */
export declare const ProductUpdate$outboundSchema: z.ZodMiniType<ProductUpdate$Outbound, ProductUpdate>;
