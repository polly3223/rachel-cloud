...
exports.AvailableScope$outboundSchema = exports.AvailableScope = void 0;
const z = __importStar(require("zod/v4-mini"));
exports.AvailableScope = {
    Openid: "openid",
    Profile: "profile",
    Email: "email",
    UserRead: "user:read",
...
/** @internal */
exports.AvailableScope$outboundSchema = z.enum(exports.AvailableScope);
