...
/** @internal */
export declare const TaxId$inboundSchema: z.ZodMiniType<TaxId, unknown>;
/** @internal */
export type TaxId$Outbound = string | string;
/** @internal */
export declare const TaxId$outboundSchema: z.ZodMiniType<TaxId$Outbound, TaxId>;
...
/** @internal */
export declare const SubscriptionCustomer$inboundSchema: z.ZodMiniType<SubscriptionCustomer, unknown>;
/** @internal */
...
/** @internal */
export declare const SubscriptionCustomer$outboundSchema: z.ZodMiniType<SubscriptionCustomer$Outbound, SubscriptionCustomer>;
