...
var ScpClient = /** @class */ (function (_super) {
    ...
    function ScpClient(options) {
        ...
        ssh
            .on("connect", function () { return _this.emit("connect"); })
            .on("ready", function () {
            ...
            .on("end", function () { return _this.emit("end"); })
            .on("close", function () {
            if (!_this.endCalled) {
                _this.sftpWrapper = null;
            }
            ...
            .on("change password", function (message, done) {
            return _this.emit("change password", message, done);
        })
            .on("tcp connection", function (details, accept, reject) {
            return _this.emit("tcp connection", details, accept, reject);
        })
            .on("banner", function (message) { return _this.emit("banner", message); })
            .on("greeting", function (greeting) { return _this.emit("banner", greeting); })
            .on("handshake", function (negotiated) { return _this.emit("handshake", negotiated); })
            .on("hostkeys", function (keys) { return _this.emit("hostkeys", keys); })
            .on("timeout", function () { return _this.emit("timeout"); })
            .on("unix connection", function (info, accept, reject) { return _this.emit("unix connection", info, accept, reject); })
            .on("x11", function (message) { return _this.emit("x11", message); });
        ssh.connect(options);
        _this.sshClient = ssh;
     ...
     */
    ScpClient.prototype.setstat = function (path, attributes) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.setstat(path, attributes, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.writeFile = function (remotePath, data, options) {
        if (options === void 0) { options = {}; }
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                ...
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.writeFile(remotePath, data, options, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.utimes = function (path, atime, mtime) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "utimes");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.utimes(path, atime, mtime, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.symlink = function (targetPath, linkPath) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "symlink");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.symlink(targetPath, linkPath, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.rename = function (srcPath, destPath) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "rename");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.rename(srcPath, destPath, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.readlink = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "readlink");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.readlink(path, function (err, target) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.readFile = function (remotePath) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "readFile");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.readFile(remotePath, function (err, handle) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.lstat = function (path) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "lstat");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.lstat(path, function (err, stats) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.appendFile = function (remotePath, data, options) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "appendFile");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.appendFile(remotePath, data, options, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.chmod = function (path, mode) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "chmod");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.chmod(path, mode, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
     ...
     */
    ScpClient.prototype.chown = function (path, uid, gid) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                utils.haveConnection(this, "chown");
                return [2 /*return*/, new Promise(function (resolve, reject) {
                        _this.sftpWrapper.chown(path, uid, gid, function (err) {
                            if (err) {
                                reject(err);
                            }
                            else {
