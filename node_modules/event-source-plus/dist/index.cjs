...
class EventSourcePlus {
  ...
  constructor(url, options = {}) {
    ...
    this.fetch = ofetch.createFetch({ fetch: options.fetch }) ?? ofetch.ofetch;
    ...
    const finalOptions = {
      ...
      onResponseError: async (context) => {
        ...
        if (typeof context.error === "undefined") {
          context.error = new ofetch.FetchError(
...
exports.EventSourceController = EventSourceController;
exports.EventSourcePlus = EventSourcePlus;
exports.EventStreamContentType = EventStreamContentType;
exports.HTTP_METHOD_VALS = HTTP_METHOD_VALS;
exports._handleResponse = _handleResponse;
exports.getBytes = getBytes;
exports.messageListFromString = messageListFromString;
