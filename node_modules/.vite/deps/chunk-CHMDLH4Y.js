...
var _a;
var IS_XHTML = ((_a = globalThis.document) == null ? void 0 : _a.contentType.includes("xml")) ?? false;
var ELEMENT_NODE = 1;
var TEXT_NODE = 3;
var COMMENT_NODE = 8;
...
function async_derived(fn, label2, location) {
  ...
  if (false_default) signal.label = label2;
  var should_suspend = !active_reaction;
  var deferreds = /* @__PURE__ */ new Map();
  async_effect(() => {
    var _a2;
    if (false_default) current_async_effect = active_effect;
    var d = deferred();
    promise = d.promise;
    try {
    ...
    if (false_default) current_async_effect = null;
    var batch = (
      /** @type {Batch} */
      current_batch
    );
...
function mark_reactions(signal, status) {
  ...
  for (var i = 0; i < length; i++) {
    ...
    if (false_default && (flags2 & EAGER_EFFECT) !== 0) {
...
function flush_effects() {
  is_flushing = true;
  var source_stacks = false_default ? /* @__PURE__ */ new Set() : null;
  try {
    var flush_count = 0;
...
//# sourceMappingURL=chunk-CHMDLH4Y.js.map
