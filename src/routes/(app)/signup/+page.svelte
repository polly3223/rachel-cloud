...
<svelte:head>
	<title>Sign Up - Rachel Cloud</title>
</svelte:head>
				...
				<div class="rounded-md shadow-sm -space-y-px">
					...
					<div>
						...
						<input
							...
							bind:value={email}
							disabled={loading}
							class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-blue-500 focus:border-blue-500 focus:z-10 sm:text-sm disabled:opacity-50 disabled:cursor-not-allowed"
