	...
	<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
		...
		<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
			<div class="flex items-center">
				...
				<div class="ml-4">
					<p class="text-sm font-medium text-gray-500">Running Containers</p>
					<p class="text-2xl font-bold text-gray-900">{overview.runningContainerCount}</p>
				</div>
			</div>
		</div>
			...
			<div class="flex items-center">
				...
				<div class="ml-4">
					...
					<div class="flex items-center gap-2">
						<p class="text-2xl font-bold text-gray-900">&euro;{overview.estimatedMonthlyCost.toFixed(0)}</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
			...
			<div>
				...
				<p class="text-lg font-semibold text-gray-900">
					~&euro;{overview.estimatedMonthlyCost.toFixed(0)}/mo
					<span class="text-sm font-normal text-gray-500">(Docker host + AI)</span>
				</p>
			</div>
			<div>
